...
/*
  IALS ADMIN BRAND + FEATURE LOCK
  --------------------------------
  This bootstrap intentionally loads two known assets in parser order:
  ...
  backup/restore, or Copilot functionality again.
*/
(() => {
  ...
  const mediaUrl = new URL('media-loader.js?v=ials-brand-lock-20260804b', assetRoot).href;
  const lockedFeatureUrl = 'https://raw.githack.com/MisfitMEdiAhouse/misfit-media-designer/41797d06d24d3cf0473d4e83a515f376de849cb7/ials-command-center-v3/assets/admin-assistant.js?v=ials-feature-lock-20260804b';
  ...
  /* Parser-ordered loading keeps IALSGuide available before admin.html initializes it. */
